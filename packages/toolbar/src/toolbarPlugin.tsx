...
import { type Plugin } from '@murasoftware/react-pdf-viewer-core';
import { fullScreenPlugin, type FullScreenPlugin, type FullScreenPluginProps } from '@murasoftware/react-pdf-viewer-full-screen';
import { getFilePlugin, type GetFilePlugin, type GetFilePluginProps } from '@murasoftware/react-pdf-viewer-get-file';
import { openPlugin, type OpenPlugin, type OpenPluginProps } from '@murasoftware/react-pdf-viewer-open';
import {
    pageNavigationPlugin,
    type PageNavigationPlugin,
    type PageNavigationPluginProps,
} from '@murasoftware/react-pdf-viewer-page-navigation';
import { printPlugin, type PrintPlugin, type PrintPluginProps } from '@murasoftware/react-pdf-viewer-print';
import { propertiesPlugin, type PropertiesPlugin } from '@murasoftware/react-pdf-viewer-properties';
import { rotatePlugin, type RotatePlugin } from '@murasoftware/react-pdf-viewer-rotate';
import { scrollModePlugin, type ScrollModePlugin } from '@murasoftware/react-pdf-viewer-scroll-mode';
import { searchPlugin, type SearchPlugin, type SearchPluginProps } from '@murasoftware/react-pdf-viewer-search';
import {
    selectionModePlugin,
    type SelectionModePlugin,
    type SelectionModePluginProps,
} from '@murasoftware/react-pdf-viewer-selection-mode';
import { themePlugin, type ThemePlugin } from '@murasoftware/react-pdf-viewer-theme';
import { zoomPlugin, type ZoomPlugin, type ZoomPluginProps } from '@murasoftware/react-pdf-viewer-zoom';

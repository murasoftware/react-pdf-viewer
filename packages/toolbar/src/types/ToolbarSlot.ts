...
import { type EnterFullScreenMenuItemProps, type EnterFullScreenProps } from '@murasoftware/react-pdf-viewer-full-screen';
import { type DownloadMenuItemProps, type DownloadProps } from '@murasoftware/react-pdf-viewer-get-file';
import { type OpenProps } from '@murasoftware/react-pdf-viewer-open';
import {
...
import { type PrintMenuItemProps, type PrintProps } from '@murasoftware/react-pdf-viewer-print';
import { type ShowPropertiesMenuItemProps, type ShowPropertiesProps } from '@murasoftware/react-pdf-viewer-properties';
import { type RotateDecoratorProps, type RotateProps } from '@murasoftware/react-pdf-viewer-rotate';
import {
    type SwitchScrollModeMenuItemProps,
    type SwitchScrollModeProps,
    type SwitchViewModeMenuItemProps,
    type SwitchViewModeProps,
} from '@murasoftware/react-pdf-viewer-scroll-mode';
import { type SearchProps, type ShowSearchPopoverProps } from '@murasoftware/react-pdf-viewer-search';
import { type SwitchSelectionModeMenuItemProps, type SwitchSelectionModeProps } from '@murasoftware/react-pdf-viewer-selection-mode';
import { type SwitchThemeMenuItemProps, type SwitchThemeProps } from '@murasoftware/react-pdf-viewer-theme';
import {
    ...
    type ZoomOutProps,
    type ZoomProps,
} from '@murasoftware/react-pdf-viewer-zoom';
